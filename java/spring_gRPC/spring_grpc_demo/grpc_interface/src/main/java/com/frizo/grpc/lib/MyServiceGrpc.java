...
public final class MyServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.frizo.grpc.lib.MyService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.frizo.grpc.lib.HelloRequest,
      com.frizo.grpc.lib.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.frizo.grpc.lib.HelloRequest.class,
      responseType = com.frizo.grpc.lib.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.frizo.grpc.lib.HelloRequest,
      com.frizo.grpc.lib.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.frizo.grpc.lib.HelloRequest, com.frizo.grpc.lib.HelloReply> getSayHelloMethod;
      ...
      synchronized (MyServiceGrpc.class) {
        if ((getSayHelloMethod = MyServiceGrpc.getSayHelloMethod) == null) {
          MyServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.frizo.grpc.lib.HelloRequest, com.frizo.grpc.lib.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.frizo.grpc.lib.HelloRequest.getDefaultInstance()))
  ...
  public static abstract class MyServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void sayHello(com.frizo.grpc.lib.HelloRequest request,
        io.grpc.stub.StreamObserver<com.frizo.grpc.lib.HelloReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.frizo.grpc.lib.HelloRequest,
                com.frizo.grpc.lib.HelloReply>(
  ...
  public static final class MyServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<MyServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.frizo.grpc.lib.HelloReply sayHello(com.frizo.grpc.lib.HelloRequest request) {
  ...
  public static final class MyServiceFutureStub extends io.grpc.stub.AbstractFutureStub<MyServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.frizo.grpc.lib.HelloReply> sayHello(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.frizo.grpc.lib.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.frizo.grpc.lib.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class MyServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.frizo.grpc.lib.HelloWorldProto.getDescriptor();
    }
